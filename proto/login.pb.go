...
var file_proto_login_proto_rawDesc = string([]byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x32, 0x5a, 0x0a, 0x05, 0x4c,
	0x6f, 0x67, 0x69, 0x6e, 0x12, 0x29, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72,
...
var file_proto_login_proto_depIdxs = []int32{
	0, // 0: Login.Register:input_type -> LoginRequest
	0, // 1: Login.Login:input_type -> LoginRequest
	1, // 2: Login.Register:output_type -> LoginResponse
	1, // 3: Login.Login:output_type -> LoginResponse
